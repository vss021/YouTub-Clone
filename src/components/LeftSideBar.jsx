  ...
  return sideBarOpen ? (
    ...
    <div className="w-[15%] text-white px-2 bg-black py-2 min-h-[92vh] max-h-[92vh] z-50 fixed flex items-center flex-col overflow-auto scrollBar pt-0">
      ...
      <section className="flex mt-4 justify-between mb-2 gap-4 self-start px-4">
        <Link to="https://www.linkedin.com/in/vijay-singh-saud/" target="_blank">
          <FaLinkedin size={20} />
        </Link>
        <Link to="https://twitter.com" target="_blank">
          <FaTwitter size={20} />
        </Link>
        <Link to="https://github.com/vss021" target="_blank">
          <FaGithub size={20} />
        </Link>
        <Link
          to="https://vijay-s-portfolio.vercel.app/"
          target="_blank"
        >
          <TfiWorld size={20} />
        </Link>
      ...
      <small className="px-4 py-1 self-start">© VIJAY SINGH SAUD </small>
    </div>
  ) : (
